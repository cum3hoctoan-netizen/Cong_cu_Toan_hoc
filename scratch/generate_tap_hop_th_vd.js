...
const quizData = {
  ...
  part1: [
    {
      id: 1,
      skill: "Xác định tập hợp bằng cách liệt kê phần tử từ phương trình tích",
      question: "Cho tập hợp $A = \\{x \\in \\mathbb{R} \\mid (x^2 - 4)(x - 1) = 0\\}$. Khẳng định nào sau đây là đúng?",
      options: [
        { key: "A", text: "$A = \\{-2, 1, 2\\}$" },
        { key: "B", text: "$A = \\{1, 2\\}$" },
        { key: "C", text: "$A = \\{-2, 2\\}$" },
      ...
      correct: "A",
      explanation: "Giải phương trình tích: $$(x^2 - 4)(x - 1) = 0 \\iff \\left[\\begin{array}{l} x^2 - 4 = 0 \\\\ x - 1 = 0 \\end{array}\\right. \\iff \\left[\\begin{array}{l} x = \\pm 2 \\\\ x = 1 \\end{array}\\right.$$<br>Vì $x \\in \\mathbb{R}$, tập hợp $A$ gồm 3 phần tử: $A = \\{-2, 1, 2\\}$."
    },
    {
      id: 2,
      skill: "Sử dụng đúng ký hiệu thuộc và tập con giữa phần tử và tập hợp",
      question: "Ký hiệu nào sau đây thể hiện đúng phát biểu: \"Số $2$ là một số tự nhiên\"?",
      options: [
        { key: "A", text: "$2 \\in \\mathbb{N}$" },
        { key: "B", text: "$2 \\subset \\mathbb{N}$" },
        { key: "C", text: "$\\{2\\} \\in \\mathbb{N}$" },
        { key: "D", text: "$2 = \\mathbb{N}$" }
      ],
      correct: "A",
      explanation: "Vì $2$ là một phần tử và $\\mathbb{N}$ là một tập hợp, mối quan hệ giữa phần tử và tập hợp phải dùng ký hiệu thuộc: $2 \\in \\mathbb{N}$.<br><i>Lưu ý:</i> Ký hiệu $\\subset$ chỉ dùng cho quan hệ giữa hai tập hợp (ví dụ: $\\{2\\} \\subset \\mathbb{N}$)."
    },
    {
      id: 3,
      skill: "Tìm giao của hai tập hợp hữu hạn rời rạc",
      question: "Cho hai tập hợp $A = \\{1, 2, 3, 4, 5\\}$ và $B = \\{2, 4, 6, 8\\}$. Tìm tập hợp $A \\cap B$.",
      options: [
        { key: "A", text: "$\\{2, 4\\}$" },
        { key: "B", text: "$\\{1, 2, 3, 4, 5, 6, 8\\}$" },
        { key: "C", text: "$\\{1, 3, 5\\}$" },
        { key: "D", text: "$\\{6, 8\\}$" }
      ],
      correct: "A",
      explanation: "Phép giao $A \\cap B$ là tập hợp gồm các phần tử vừa thuộc $A$ vừa thuộc $B$.<br>Các phần tử chung của $A$ và $B$ là $2$ và $4$, do đó $A \\cap B = \\{2, 4\\}$."
    },
    {
      id: 4,
      skill: "Tìm hiệu của hai tập hợp hữu hạn rời rạc",
      question: "Cho hai tập hợp $A = \\{-1, 0, 1, 2\\}$ và $B = \\{0, 2, 4\\}$. Tìm tập hợp hiệu $A \\setminus B$.",
      options: [
        { key: "A", text: "$\\{-1, 1\\}$" },
        { key: "B", text: "$\\{0, 2\\}$" },
        { key: "C", text: "$\\{4\\}$" },
        { key: "D", text: "$\\{-1, 0, 1, 2, 4\\}$" }
      ],
      correct: "A",
      explanation: "Hiệu $A \\setminus B$ là tập hợp gồm các phần tử thuộc $A$ nhưng không thuộc $B$.<br>Loại bỏ các phần tử $0$ và $2$ khỏi $A$, ta còn lại: $A \\setminus B = \\{-1, 1\\}$."
    },
    {
      id: 5,
      skill: "Tìm hợp của hai khoảng nửa khoảng trên trục số thực",
      question: "Cho tập hợp $A = (-2; 3]$ và $B = (1; 5)$. Tìm tập hợp $A \\cup B$.",
      options: [
        { key: "A", text: "$(-2; 5)$" },
        { key: "B", text: "$(1; 3]$" },
        { key: "C", text: "$[-2; 5]$" },
      ...
      correct: "A",
      explanation: "Biểu diễn hai tập hợp trên trục số thực:<br>$A = (-2; 3]$ và $B = (1; 5)$.<br>Vì $1 < 3$, hai tập hợp gối đầu lên nhau liên tục từ $-2$ đến $5$.<br>Vậy hợp của hai tập hợp là khoảng $(-2; 5)$."
    },
    {
      id: 6,
      skill: "Tìm phần bù của một đoạn trong tập số thực",
      question: "Cho tập hợp $A = [-1; 4]$. Tìm phần bù $C_{\\mathbb{R}} A$.",
      options: [
        { key: "A", text: "$(-\\infty; -1) \\cup (4; +\\infty)$" },
        { key: "B", text: "$(-\\infty; -1] \\cup [4; +\\infty)$" },
        { key: "C", text: "$(-\\infty; 4)$" },
        { key: "D", text: "$(4; +\\infty)$" }
      ],
      correct: "A",
      explanation: "Phần bù của $A$ trong $\\mathbb{R}$ là: $$C_{\\mathbb{R}} A = \\mathbb{R} \\setminus A = \\mathbb{R} \\setminus [-1; 4] = (-\\infty; -1) \\cup (4; +\\infty)$$<br><i>Lưu ý:</i> Vì $A$ lấy cả hai đầu mút $-1$ và $4$ nên phần bù không lấy hai giá trị này (dùng ngoặc tròn)."
    },
    {
      id: 7,
      skill: "Tính số tập con của một tập hợp hữu hạn",
      question: "Tập hợp $A = \\{a, b, c\\}$ có tất cả bao nhiêu tập hợp con?",
      options: [
        { key: "A", text: "$8$" },
        { key: "B", text: "$6$" },
        { key: "C", text: "$7$" },
      ...
      correct: "A",
      explanation: "Tập hợp $A$ có $n = 3$ phần tử.<br>Công thức số tập con của một tập hợp có $n$ phần tử là $2^n$.<br>Do đó, số tập hợp con của $A$ là $2^3 = 8$."
    },
    {
      id: 8,
      skill: "Tìm tham số để giao của hai khoảng bằng rỗng",
      question: "Cho hai khoảng $A = (-\\infty; m)$ và $B = (3; +\\infty)$. Tìm điều kiện của tham số $m$ để $A \\cap B = \\emptyset$.",
      options: [
        { key: "A", text: "$m \\le 3$" },
        { key: "B", text: "$m < 3$" },
        { key: "C", text: "$m > 3$" },
      ...
      correct: "A",
      explanation: "Để khoảng $(-\\infty; m)$ và khoảng $(3; +\\infty)$ không có phần tử chung thì mút phải của $A$ phải nhỏ hơn hoặc bằng mút trái của $B$, tức là $m \\le 3$.<br>(Khi $m = 3$, $A = (-\\infty; 3)$ và $B = (3; +\\infty)$, cả hai khoảng đều không chứa điểm $3$ nên giao vẫn bằng rỗng)."
    },
    {
      id: 9,
      skill: "Tìm điều kiện tham số để đoạn là tập con của khoảng",
      question: "Cho hai tập hợp $A = [m-1; m+3]$ và $B = (-2; 5)$. Tìm tất cả các giá trị của $m$ để $A \\subset B$.",
      options: [
        { key: "A", text: "$-1 < m < 2$" },
        { key: "B", text: "$-1 \\le m \\le 2$" },
        { key: "C", text: "$m > -1$" },
        { key: "D", text: "$m < 2$" }
      ],
      correct: "A",
      explanation: "Để đoạn $[m-1; m+3]$ nằm trọn trong khoảng mở $(-2; 5)$ thì hai đầu mút của đoạn phải nằm hoàn toàn phía trong khoảng:<br>$$\\begin{cases} m - 1 > -2 \\\\ m + 3 < 5 \\end{cases} \\iff \\begin{cases} m > -1 \\\\ m < 2 \\end{cases} \\iff -1 < m < 2$$"
    },
    {
      id: 10,
      skill: "Ứng dụng công thức nguyên lý bù trừ giải bài toán hai tập hợp",
      question: "Lớp 10A có 42 học sinh, trong đó có 25 học sinh thích môn Toán, 18 học sinh thích môn Tiếng Anh và 8 học sinh không thích môn nào trong hai môn này. Hỏi có bao nhiêu học sinh thích cả hai môn Toán và Tiếng Anh?",
      options: [
        { key: "A", text: "$9$" },
        { key: "B", text: "$7$" },
        { key: "C", text: "$11$" },
      ...
      correct: "A",
      explanation: "Số học sinh thích ít nhất một trong hai môn là: $$42 - 8 = 34\\text{ học sinh}$$<br>Áp dụng công thức nguyên lý bù trừ: $$|T \\cup A| = |T| + |A| - |T \\cap A|$$<br>$$\\iff 34 = 25 + 18 - |T \\cap A| \\implies |T \\cap A| = 43 - 34 = 9\\text{ học sinh}$$"
    }
  ],
  part2: [
    {
      id: 1,
      skill: "Xác định phần tử, quan hệ bao hàm và giao của hai tập hợp",
      context: "Cho hai tập hợp $A = \\{x \\in \\mathbb{R} \\mid x^2 - 5x + 6 = 0\\}$ và $B = \\{x \\in \\mathbb{Z} \\mid -1 \\le x \\le 3\\}$:",
      items: [
        {
          label: "a",
          text: "Viết tập hợp $A$ dưới dạng liệt kê phần tử ta được $A = \\{2, 3\\}$.",
          correct: true,
          explanation: "$x^2 - 5x + 6 = 0 \\iff x = 2$ hoặc $x = 3 \\implies A = \\{2, 3\\}$. Mệnh đề ĐÚNG."
        },
        {
          label: "b",
          text: "Số phần tử của tập hợp $B$ là $4$ phần tử.",
          correct: false,
          explanation: "Các số nguyên $-1 \\le x \\le 3$ là $\\{-1, 0, 1, 2, 3\\}$, gồm $5$ phần tử chứ không phải $4$. Mệnh đề SAI."
        },
        {
          label: "c",
          text: "Giao của hai tập hợp là $A \\cap B = \\{2, 3\\}$.",
          correct: true,
          explanation: "Cả $2$ và $3$ đều thuộc $A$ và thuộc $B$, do đó $A \\cap B = \\{2, 3\\}$. Mệnh đề ĐÚNG."
        },
        {
          label: "d",
          text: "Tập hợp $A$ không phải là tập con của tập hợp $B$ ($A \\not\\subset B$).",
          correct: false,
          explanation: "Vì cả hai phần tử $2, 3$ của $A$ đều thuộc $B$ nên $A \\subset B$. Phát biểu $A \\not\\subset B$ là SAI."
        }
      ]
    },
    {
      id: 2,
      skill: "Các phép toán hợp, giao, hiệu, phần bù trên khoảng, nửa khoảng",
      context: "Cho hai tập hợp $A = [-3; 2)$ và $B = (0; 5]$ trên tập số thực $\\mathbb{R}$:",
      items: [
        {
          label: "a",
          text: "Hợp của hai tập hợp là $A \\cup B = [-3; 5]$.",
          correct: true,
          explanation: "$[-3; 2) \\cup (0; 5] = [-3; 5]$. Mệnh đề ĐÚNG."
        },
        {
          label: "b",
          text: "Giao của hai tập hợp là $A \\cap B = (0; 2)$.",
          correct: true,
          explanation: "$[-3; 2) \\cap (0; 5] = (0; 2)$. Mệnh đề ĐÚNG."
        },
        {
          label: "c",
          text: "Hiệu của hai tập hợp là $A \\setminus B = [-3; 0]$.",
          correct: true,
          explanation: "Vì $0 \\notin B$ nên phần tử $0$ còn lại trong tập hiệu, suy ra $A \\setminus B = [-3; 0]$. Mệnh đề ĐÚNG."
        },
        {
          label: "d",
          text: "Phần bù của $A$ trong $\\mathbb{R}$ là $C_{\\mathbb{R}} A = (-\\infty; -3) \\cup [2; +\\infty)$.",
          correct: true,
          explanation: "Phần bù của $[-3; 2)$ trong $\\mathbb{R}$ là $\\mathbb{R} \\setminus [-3; 2) = (-\\infty; -3) \\cup [2; +\\infty)$. Mệnh đề ĐÚNG."
        }
      ]
    },
    {
      id: 3,
      skill: "Mối quan hệ giữa các tập hợp số tự nhiên, nguyên, hữu tỉ, vô tỉ, thực",
      context: "Xét quan hệ bao hàm giữa các tập hợp số $\\mathbb{N}, \\mathbb{Z}, \\mathbb{Q}, \\mathbb{R}$:",
      items: [
        {
          label: "a",
          text: "Tập hợp các số tự nhiên $\\mathbb{N}$ là tập con của tập hợp các số nguyên $\\mathbb{Z}$ ($\\mathbb{N} \\subset \\mathbb{Z}$).",
          correct: true,
          explanation: "Mọi số tự nhiên đều là số nguyên không âm nên $\\mathbb{N} \\subset \\mathbb{Z}$. Mệnh đề ĐÚNG."
        },
        {
          label: "b",
          text: "Phép giao $\\mathbb{Z} \\cap \\mathbb{Q} = \\mathbb{Z}$.",
          correct: true,
          explanation: "Vì mọi số nguyên đều là số hữu tỉ ($\\mathbb{Z} \\subset \\mathbb{Q}$) nên $\\mathbb{Z} \\cap \\mathbb{Q} = \\mathbb{Z}$. Mệnh đề ĐÚNG."
        },
        {
          label: "c",
          text: "Phép hiệu $\\mathbb{R} \\setminus \\mathbb{Q}$ là tập hợp các số vô tỉ $\\mathbb{I}$.",
          correct: true,
          explanation: "Theo đúng định nghĩa toán học, tập hợp các số vô tỉ $\\mathbb{I} = \\mathbb{R} \\setminus \\mathbb{Q}$. Mệnh đề ĐÚNG."
        },
        {
          label: "d",
          text: "Phần bù $C_{\\mathbb{R}} \\mathbb{N} = (0; +\\infty)$.",
          correct: false,
          explanation: "Tập hợp $\\mathbb{N}$ là tập rời rạc, phần bù $C_{\\mathbb{R}} \\mathbb{N} = \\mathbb{R} \\setminus \\{0, 1, 2, \\dots\\}$, không thể là khoảng liên tục $(0; +\\infty)$. Mệnh đề SAI."
        }
      ]
    },
    {
      id: 4,
      skill: "Biện luận tham số m đối với các quan hệ tập hợp",
      context: "Cho hai tập hợp phụ thuộc tham số $m$: $A = (1; m+1]$ và $B = (2; 6)$:",
      items: [
        {
          label: "a",
          text: "Điều kiện để tập hợp $A$ khác rỗng ($A \\neq \\emptyset$) là $m > 0$.",
          correct: true,
          explanation: "Khoảng $(1; m+1] \\neq \\emptyset \\iff m+1 > 1 \\iff m > 0$. Mệnh đề ĐÚNG."
        },
        {
          label: "b",
          text: "Khi $m = 4$, tập hợp $A = (1; 5]$ và $A \\cap B = (2; 5]$.",
          correct: true,
          explanation: "Khi $m = 4 \\implies A = (1; 5]$. Do $1 < 2 < 5 < 6$, ta có $A \\cap B = (1; 5] \\cap (2; 6) = (2; 5]$. Mệnh đề ĐÚNG."
        },
        {
          label: "c",
          text: "Điều kiện của $m$ để $A \\cap B = \\emptyset$ là $m \\le 1$.",
          correct: true,
          explanation: "Để $(1; m+1] \\cap (2; 6) = \\emptyset$, nửa khoảng $A$ phải kết thúc trước khi $B$ bắt đầu: $m+1 \\le 2 \\iff m \\le 1$. Mệnh đề ĐÚNG."
        },
        {
          label: "d",
          text: "Điều kiện của $m$ để $B \\subset A$ là $m \\ge 5$.",
          correct: true,
          explanation: "Để $(2; 6) \\subset (1; m+1]$, ta cần $m+1 \\ge 6 \\iff m \\ge 5$. Mệnh đề ĐÚNG."
        }
      ]
    }
  ],
  part3: [
    {
      ...
      question: "Câu 1. Cho tập hợp $A = \\{x \\in \\mathbb{R} \\mid (x^2 - 9)(x^2 - 4x + 3) = 0\\}$. Hỏi tập hợp $A$ có tất cả bao nhiêu tập hợp con?",
      answer_display: "8",
      acceptable: ["8"],
      explanation: "Phương trình $(x^2 - 9)(x^2 - 4x + 3) = 0 \\iff \\left[\\begin{array}{l} x = \\pm 3 \\\\ x = 1 \\\\ x = 3 \\end{array}\\right. \\iff x \\in \\{-3, 1, 3\\}$.<br>Tập $A = \\{-3, 1, 3\\}$ có $n = 3$ phần tử phân biệt.<br>Số tập con của $A$ là $2^3 = 8$."
    },
    {
      id: 2,
      skill: "Tìm điều kiện tham số để một khoảng là tập con của một đoạn",
      question: "Câu 2. Cho hai khoảng $A = [-2; 4]$ và $B = (m; m+3)$. Tìm tất cả các giá trị thực của tham số $m$ để $B \\subset A$.",
      answer_display: "$-2 \\le m \\le 1$",
      acceptable: ["-2 <= m <= 1", "-2<=m<=1", "[-2; 1]", "[-2;1]", "m in [-2; 1]"],
      explanation: "Để $B = (m; m+3) \\subset A = [-2; 4]$, ta cần:<br>$$\\begin{cases} m \\ge -2 \\\\ m + 3 \\le 4 \\end{cases} \\iff \\begin{cases} m \\ge -2 \\\\ m \\le 1 \\end{cases} \\iff -2 \\le m \\le 1$$"
    },
    {
      id: 3,
      skill: "Tìm điều kiện tham số để giao của hai nửa khoảng bằng rỗng",
      question: "Câu 3. Cho hai tập hợp $A = (-\\infty; m+1]$ và $B = (2; +\\infty)$. Tìm tất cả các giá trị thực của tham số $m$ để $A \\cap B = \\emptyset$.",
      answer_display: "$m \\le 1$",
      acceptable: ["m <= 1", "m<=1", "(-\\infty; 1]", "(-inf; 1]", "(-oo; 1]"],
      explanation: "Để hai nửa khoảng không giao nhau, nửa khoảng bên trái phải dừng lại trước điểm bắt đầu của khoảng bên phải:<br>$$m + 1 \\le 2 \\iff m \\le 1$$"
    },
    {
      id: 4,
      skill: "Ứng dụng sơ đồ Venn giải bài toán giao của hai tập hợp thực tế",
      question: "Câu 4. Một công ty phỏng vấn 100 khách hàng về việc sử dụng hai sản phẩm A và B. Kết quả có 65 người dùng sản phẩm A, 45 người dùng sản phẩm B và 15 người không dùng sản phẩm nào. Hỏi có bao nhiêu người dùng CẢ HAI sản phẩm A và B?",
      answer_display: "25",
      acceptable: ["25"],
      explanation: "Số khách hàng dùng ít nhất một sản phẩm A hoặc B là: $$100 - 15 = 85\\text{ người}$$<br>Số người dùng CẢ HAI sản phẩm A và B là: $$|A \\cap B| = |A| + |B| - |A \\cup B| = 65 + 45 - 85 = 25\\text{ người}$$"
    },
    {
      id: 5,
      skill: "Ứng dụng tập hợp giải bài toán đếm phần tử chỉ thuộc một tập hợp",
      question: "Câu 5 (Vận dụng thực tế). Lớp 10B có 40 học sinh. Trong kỳ thi học sinh giỏi cấp trường, có 22 học sinh thi môn Toán, 18 học sinh thi môn Vật lý và 10 học sinh không thi môn nào. Trường quyết định trao thưởng cho các học sinh thi CHỈ MỘT môn. Hỏi có bao nhiêu học sinh lớp 10B được trao thưởng?",
      answer_display: "20",
      acceptable: ["20"],
      explanation: "Số học sinh thi ít nhất một môn là: $$40 - 10 = 30\\text{ học sinh}$$<br>Số học sinh thi CẢ HAI môn Toán và Lý là: $$22 + 18 - 30 = 10\\text{ học sinh}$$<br>Số học sinh thi CHỈ MỘT môn được trao thưởng là: $$30 - 10 = 20\\text{ học sinh}$$<br>(Gồm $22 - 10 = 12$ em chỉ thi Toán và $18 - 10 = 8$ em chỉ thi Lý)."
    }
  ]
};
...
<body>
      ...
      <div class="exam-header-card">
        <div class="exam-info">
          ...
          <div class="exam-meta-tags">
            ...
            <span class="meta-tag red">🎯 19 câu hỏi Thông hiểu & Vận dụng</span>
  ...
  <script>
    ...
    // solution_mode: BAT => mặc định BẬT
    ...
    function chamDiemBaiThi() {
      ...
      // 2. Chấm Phần II (4 câu, Đúng-Sai: 1 ý 0.1đ, 2 ý 0.25đ, 3 ý 0.5đ, 4 ý 1.0đ)
      ...
      if (diem_so < 5.0) {
        ...
        gradeSub = "Cần chú ý kỹ các điều kiện mút biên và các quan hệ tập con.";
      }
...
const outputPath = path.join(__dirname, '..', 'To10_Web', 'To10_C1_B2_TapHop_TH_VD.html');
