...
const quizData = {
  title: "PHIẾU HỌC TẬP INFOGRAPHIC: GIÁ TRỊ LƯỢNG GIÁC CỦA MỘT GÓC TỪ 0° ĐẾN 180°",
  subtitle: "Chuyên đề Toán 10 - Chương III: Hệ thức lượng trong tam giác (GDPT 2018)",
  level: "Thông hiểu và Vận dụng",
  solutionMode: "BAT",
  part1: [
    {
      id: 1,
      skill: "Tính giá trị lượng giác của góc đặc biệt lớn hơn 90 độ",
      ...
      correct: "A",
      explanation: "Sử dụng công thức hai góc bù nhau: $$\\cos 120^\\circ = -\\cos(180^\\circ - 120^\\circ) = -\\cos 60^\\circ = -\\dfrac{1}{2}$$"
    },
    {
      id: 2,
      skill: "Nhận biết công thức lượng giác của hai góc bù nhau",
      question: "Cho hai góc bù nhau $\\alpha$ và $\\beta$ (tức là $\\alpha + \\beta = 180^\\circ$). Khẳng định nào sau đây là SAI?",
      options: [
        { key: "A", text: "$\\sin \\alpha = \\sin \\beta$" },
        { key: "B", text: "$\\cos \\alpha = -\\cos \\beta$" },
        { key: "C", text: "$\\tan \\alpha = -\\tan \\beta$ $(\\alpha \\neq 90^\\circ)$" },
        { key: "D", text: "$\\cot \\alpha = \\cot \\beta$ $(\\alpha, \\beta \\notin \\{0^\\circ, 180^\\circ\\})$" }
      ],
      correct: "D",
      explanation: "Hai góc bù nhau có sin bằng nhau, còn cos, tan, cot thì đối dấu nhau:<br>$$\\sin \\alpha = \\sin \\beta, \\quad \\cos \\alpha = -\\cos \\beta, \\quad \\tan \\alpha = -\\tan \\beta, \\quad \\cot \\alpha = -\\cot \\beta$$<br>Do đó khẳng định D: $\\cot \\alpha = \\cot \\beta$ là SAI."
    },
    {
      id: 3,
      skill: "Định nghĩa giá trị lượng giác theo tọa độ điểm trên nửa đường tròn đơn vị",
      question: "Trong mặt phẳng tọa độ $Oxy$, cho điểm $M(x_0; y_0)$ nằm trên nửa đường tròn đơn vị sao cho $\\widehat{xOM} = \\alpha$. Khẳng định nào sau đây là đúng?",
      options: [
        { key: "A", text: "$\\sin \\alpha = x_0$" },
        { key: "B", text: "$\\cos \\alpha = y_0$" },
        { key: "C", text: "$\\tan \\alpha = \\dfrac{y_0}{x_0}$ $(x_0 \\neq 0)$" },
        { key: "D", text: "$\\cot \\alpha = \\dfrac{y_0}{x_0}$ $(y_0 \\neq 0)$" }
      ],
      correct: "C",
      explanation: "Theo định nghĩa trên nửa đường tròn đơn vị:<br>• Hoành độ của $M$ là cosin: $\\cos \\alpha = x_0$<br>• Tung độ của $M$ là sin: $\\sin \\alpha = y_0$<br>• $\\tan \\alpha = \\dfrac{y_0}{x_0}$ ($x_0 \\neq 0$)<br>• $\\cot \\alpha = \\dfrac{x_0}{y_0}$ ($y_0 \\neq 0$)<br>Vậy khẳng định C đúng."
    },
    {
      id: 4,
      skill: "Tính cosin của góc tù khi biết sin",
      question: "Cho góc $\\alpha$ thỏa mãn $90^\\circ < \\alpha < 180^\\circ$ và $\\sin \\alpha = \\dfrac{3}{5}$. Tính $\\cos \\alpha$.",
      options: [
        { key: "A", text: "$\\cos \\alpha = \\dfrac{4}{5}$" },
        { key: "B", text: "$\\cos \\alpha = -\\dfrac{4}{5}$" },
        { key: "C", text: "$\\cos \\alpha = \\dfrac{16}{25}$" },
        { key: "D", text: "$\\cos \\alpha = -\\dfrac{16}{25}$" }
      ],
      correct: "B",
      explanation: "Áp dụng hằng đẳng thức $\\sin^2 \\alpha + \\cos^2 \\alpha = 1$:<br>$$\\cos^2 \\alpha = 1 - \\sin^2 \\alpha = 1 - \\left(\\dfrac{3}{5}\\right)^2 = \\dfrac{16}{25}$$<br>Vì $90^\\circ < \\alpha < 180^\\circ$ (góc tù) nên $\\cos \\alpha < 0$. Do đó: $$\\cos \\alpha = -\\sqrt{\\dfrac{16}{25}} = -\\dfrac{4}{5}$$"
    },
    {
      id: 5,
      skill: "Tính giá trị biểu thức phân thức bậc nhất thuần nhất theo tan",
      question: "Cho $\\tan \\alpha = 3$. Tính giá trị của biểu thức $P = \\dfrac{2\\sin \\alpha - \\cos \\alpha}{\\sin \\alpha + \\cos \\alpha}$.",
      options: [
        { key: "A", text: "$P = \\dfrac{5}{4}$" },
        { key: "B", text: "$P = \\dfrac{7}{4}$" },
        { key: "C", text: "$P = \\dfrac{5}{2}$" },
        { key: "D", text: "$P = 2$" }
      ],
      correct: "A",
      explanation: "Vì $\\tan \\alpha = 3$ xác định nên $\\cos \\alpha \\neq 0$. Chia cả tử và mẫu của biểu thức $P$ cho $\\cos \\alpha$:<br>$$P = \\dfrac{2\\dfrac{\\sin \\alpha}{\\cos \\alpha} - 1}{\\dfrac{\\sin \\alpha}{\\cos \\alpha} + 1} = \\dfrac{2\\tan \\alpha - 1}{\\tan \\alpha + 1} = \\dfrac{2(3) - 1}{3 + 1} = \\dfrac{5}{4}$$"
    },
    {
      id: 6,
      skill: "Rút gọn biểu thức lượng giác sử dụng góc phụ và góc bù",
      question: "Giá trị của biểu thức $S = \\sin^2 25^\\circ + \\sin^2 65^\\circ + \\cos^2 35^\\circ + \\sin^2 145^\\circ$ bằng bao nhiêu?",
      options: [
        { key: "A", text: "$1$" },
        { key: "B", text: "$2$" },
        { key: "C", text: "$0$" },
      ...
      correct: "B",
      explanation: "Áp dụng công thức góc phụ: $\\sin 65^\\circ = \\cos 25^\\circ \\implies \\sin^2 25^\\circ + \\sin^2 65^\\circ = \\sin^2 25^\\circ + \\cos^2 25^\\circ = 1$.<br>Áp dụng công thức góc bù: $\\sin 145^\\circ = \\sin(180^\\circ - 35^\\circ) = \\sin 35^\\circ \\implies \\cos^2 35^\\circ + \\sin^2 145^\\circ = \\cos^2 35^\\circ + \\sin^2 35^\\circ = 1$.<br>Vậy $$S = 1 + 1 = 2$$"
    },
    {
      id: 7,
      skill: "Biến đổi lượng giác các góc trong tam giác",
      question: "Trong tam giác $ABC$, giá trị của $\\sin(A + B)$ bằng giá trị nào dưới đây?",
      options: [
        { key: "A", text: "$\\sin C$" },
        { key: "B", text: "$-\\sin C$" },
        { key: "C", text: "$\\cos C$" },
      ...
      correct: "A",
      explanation: "Trong tam giác $ABC$, $A + B + C = 180^\\circ \\implies A + B = 180^\\circ - C$.<br>Vì hai góc $A+B$ và $C$ bù nhau nên: $$\\sin(A + B) = \\sin(180^\\circ - C) = \\sin C$$"
    },
    {
      id: 8,
      skill: "Xét dấu các giá trị lượng giác của góc tù",
      question: "Cho góc $\\alpha$ thỏa mãn $0^\\circ \\le \\alpha \\le 180^\\circ$. Mệnh đề nào sau đây là đúng?",
      options: [
        { key: "A", text: "$\\sin \\alpha > 0$ với mọi góc $\\alpha$" },
        { key: "B", text: "$\\cos \\alpha < 0$ khi $\\alpha$ là góc tù" },
        { key: "C", text: "$\\tan \\alpha > 0$ khi $\\alpha$ là góc tù" },
        { key: "D", text: "$\\cot \\alpha > 0$ khi $\\alpha$ là góc tù" }
      ],
      correct: "B",
      explanation: "Khi $\\alpha$ là góc tù ($90^\\circ < \\alpha < 180^\\circ$):<br>• Điểm biểu diễn $M$ nằm ở góc phần tư thứ II nên có hoành độ âm $x_0 < 0 \\implies \\cos \\alpha < 0$ (Đúng).<br>• $\\sin \\alpha > 0$, do đó $\\tan \\alpha < 0$ và $\\cot \\alpha < 0$."
    },
    {
      id: 9,
      skill: "Tính giá trị biểu thức tích các giá trị lượng giác phụ nhau và góc đặc biệt",
      question: "Rút gọn biểu thức $A = \\tan 20^\\circ \\cdot \\tan 70^\\circ + \\cos 150^\\circ \\cdot \\cot 60^\\circ$.",
      options: [
        { key: "A", text: "$A = \\dfrac{1}{2}$" },
        { key: "B", text: "$A = -\\dfrac{1}{2}$" },
        { key: "C", text: "$A = 0$" },
        { key: "D", text: "$A = \\dfrac{3}{2}$" }
      ],
      correct: "A",
      explanation: "Ta có $20^\\circ$ và $70^\\circ$ phụ nhau nên $\\tan 70^\\circ = \\cot 20^\\circ \\implies \\tan 20^\\circ \\cdot \\tan 70^\\circ = 1$.<br>$\\cos 150^\\circ = -\\cos 30^\\circ = -\\dfrac{\\sqrt{3}}{2}$, $\\cot 60^\\circ = \\dfrac{\\sqrt{3}}{3}$.<br>Tích: $\\cos 150^\\circ \\cdot \\cot 60^\\circ = -\\dfrac{\\sqrt{3}}{2} \\cdot \\dfrac{\\sqrt{3}}{3} = -\\dfrac{1}{2}$.<br>Vậy $$A = 1 - \\dfrac{1}{2} = \\dfrac{1}{2}$$"
    },
    {
      id: 10,
      skill: "Xác định tọa độ điểm trên nửa đường tròn đơn vị tương ứng với góc 150 độ",
      question: "Một điểm $M$ di chuyển trên nửa đường tròn đơn vị $x^2 + y^2 = 1$ ($y \\ge 0$). Khi vị trí của $M$ ứng với góc $\\alpha = 150^\\circ$, tọa độ của điểm $M$ là:",
      options: [
        { key: "A", text: "$M\\left(-\\dfrac{\\sqrt{3}}{2}; \\dfrac{1}{2}\\right)$" },
        { key: "B", text: "$M\\left(\\dfrac{1}{2}; -\\dfrac{\\sqrt{3}}{2}\\right)$" },
        { key: "C", text: "$M\\left(-\\dfrac{1}{2}; \\dfrac{\\sqrt{3}}{2}\\right)$" },
        { key: "D", text: "$M\\left(\\dfrac{\\sqrt{3}}{2}; \\dfrac{1}{2}\\right)$" }
      ],
      correct: "A",
      explanation: "Tọa độ của điểm $M$ ứng với góc $\\alpha = 150^\\circ$ là:<br>$$x_M = \\cos 150^\\circ = -\\cos 30^\\circ = -\\dfrac{\\sqrt{3}}{2}$$<br>$$y_M = \\sin 150^\\circ = \\sin 30^\\circ = \\dfrac{1}{2}$$<br>Vậy $M\\left(-\\dfrac{\\sqrt{3}}{2}; \\dfrac{1}{2}\\right)$."
    }
  ],
  part2: [
    {
      id: 1,
      skill: "Tính giá trị lượng giác của góc 135 độ và tọa độ điểm biểu diễn",
      context: "Cho góc $\\alpha = 135^\\circ$. Xét các khẳng định sau:",
      items: [
        {
          label: "a",
          text: "Điểm đại diện $M$ cho góc $\\alpha$ trên nửa đường tròn đơn vị nằm ở góc phần tư thứ II và có tung độ dương.",
          correct: true,
          explanation: "Vì $90^\\circ < 135^\\circ < 180^\\circ$, điểm $M$ thuộc góc phần tư thứ II và tung độ $y_M = \\sin 135^\\circ > 0$. Mệnh đề ĐÚNG."
        },
        {
          label: "b",
          text: "Giá trị của $\\sin 135^\\circ$ là $\\dfrac{\\sqrt{2}}{2}$.",
          correct: true,
          explanation: "$\\sin 135^\\circ = \\sin(180^\\circ - 45^\\circ) = \\sin 45^\\circ = \\dfrac{\\sqrt{2}}{2}$. Mệnh đề ĐÚNG."
        },
        {
          label: "c",
          text: "Giá trị của $\\cos 135^\\circ$ là $\\dfrac{\\sqrt{2}}{2}$.",
          correct: false,
          explanation: "$\\cos 135^\\circ = -\\cos 45^\\circ = -\\dfrac{\\sqrt{2}}{2}$. Đề ghi $\\dfrac{\\sqrt{2}}{2}$ là SAI."
        },
        {
          label: "d",
          text: "Giá trị của biểu thức $\\tan 135^\\circ + \\cot 135^\\circ$ bằng $-2$.",
          correct: true,
          explanation: "$\\tan 135^\\circ = -1$ và $\\cot 135^\\circ = -1 \\implies \\tan 135^\\circ + \\cot 135^\\circ = -2$. Mệnh đề ĐÚNG."
        }
      ]
    },
    {
      id: 2,
      skill: "Tính các giá trị lượng giác còn lại khi biết cosin của một góc tù",
      context: "Cho góc tù $\\alpha$ ($90^\\circ < \\alpha < 180^\\circ$) thỏa mãn $\\cos \\alpha = -\\dfrac{5}{13}$:",
      items: [
        {
          label: "a",
          text: "Giá trị của $\\sin \\alpha$ bằng $\\dfrac{12}{13}$.",
          correct: true,
          explanation: "Vì $\\alpha$ tù nên $\\sin \\alpha > 0 \\implies \\sin \\alpha = \\sqrt{1 - (-5/13)^2} = \\dfrac{12}{13}$. Mệnh đề ĐÚNG."
        },
        {
          label: "b",
          text: "Giá trị của $\\tan \\alpha$ bằng $\\dfrac{12}{5}$.",
          correct: false,
          explanation: "$\\tan \\alpha = \\dfrac{\\sin \\alpha}{\\cos \\alpha} = \\dfrac{12/13}{-5/13} = -\\dfrac{12}{5}$. Đề ghi $\\dfrac{12}{5}$ là SAI."
        },
        {
          label: "c",
          text: "Giá trị của $\\cot \\alpha$ bằng $-\\dfrac{5}{12}$.",
          correct: true,
          explanation: "$\\cot \\alpha = \\dfrac{1}{\\tan \\alpha} = -\\dfrac{5}{12}$. Mệnh đề ĐÚNG."
        },
        {
          label: "d",
          text: "Giá trị của biểu thức $P = \\sin \\alpha + \\cos \\alpha$ bằng $\\dfrac{7}{13}$.",
          correct: true,
          explanation: "$P = \\dfrac{12}{13} + \\left(-\\dfrac{5}{13}\\right) = \\dfrac{7}{13}$. Mệnh đề ĐÚNG."
        }
      ]
    },
    {
      id: 3,
      skill: "Hệ thức lượng giác liên hệ giữa các góc và nửa góc trong tam giác",
      context: "Cho tam giác $ABC$ không vuông. Xét tính đúng/sai của các đẳng thức lượng giác sau:",
      items: [
        {
          label: "a",
          text: "$\\sin(A + B) = \\sin C$.",
        ...
        },
        {
          ...
          text: "$\\tan(A + B) = -\\tan C$.",
          correct: true,
          explanation: "$\\tan(A + B) = \\tan(180^\\circ - C) = -\\tan C$. Mệnh đề ĐÚNG."
        },
        {
          label: "d",
    ...
    {
      id: 4,
      skill: "Rút gọn chuỗi tổng bình phương sin của các góc phụ nhau",
      context: "Cho biểu thức $B = \\sin^2 10^\\circ + \\sin^2 20^\\circ + \\sin^2 30^\\circ + \\sin^2 60^\\circ + \\sin^2 70^\\circ + \\sin^2 80^\\circ$:",
      items: [
        {
          label: "a",
          text: "Mối quan hệ giữa $\\sin 80^\\circ$ và $\\cos 10^\\circ$ là $\\sin 80^\\circ = \\cos 10^\\circ$.",
          correct: true,
          explanation: "Do $80^\\circ + 10^\\circ = 90^\\circ$ nên $\\sin 80^\\circ = \\cos 10^\\circ$. Mệnh đề ĐÚNG."
        },
        {
          label: "b",
          text: "Giá trị của tổng $\\sin^2 10^\\circ + \\sin^2 80^\\circ = 1$.",
          correct: true,
          explanation: "$\\sin^2 10^\\circ + \\sin^2 80^\\circ = \\sin^2 10^\\circ + \\cos^2 10^\\circ = 1$. Mệnh đề ĐÚNG."
        },
        {
          label: "c",
          text: "Giá trị của biểu thức $B$ sau khi thu gọn bằng $3$.",
          correct: true,
          explanation: "Ghép 3 cặp phụ nhau: $(\\sin^2 10^\\circ + \\sin^2 80^\\circ) + (\\sin^2 20^\\circ + \\sin^2 70^\\circ) + (\\sin^2 30^\\circ + \\sin^2 60^\\circ) = 1 + 1 + 1 = 3$. Mệnh đề ĐÚNG."
        },
        {
          label: "d",
          text: "Giá trị của biểu thức $B + \\tan 45^\\circ$ bằng $5$.",
          correct: false,
          explanation: "Ta có $B + \\tan 45^\\circ = 3 + 1 = 4 \\neq 5$. Mệnh đề SAI."
        }
      ]
    }
  ],
  part3: [
    {
      id: 1,
      skill: "Tính giá trị biểu thức bậc 2 của sin và cos",
      question: "Câu 1. Cho $\\cos \\alpha = -\\dfrac{1}{3}$ với $0^\\circ \\le \\alpha \\le 180^\\circ$. Tính giá trị của biểu thức $P = 3\\sin^2 \\alpha + \\cos^2 \\alpha$.",
      answer_display: "25/9",
      acceptable: ["25/9", "25 / 9", "2.78", "2,78"],
      explanation: "Ta có $\\sin^2 \\alpha = 1 - \\cos^2 \\alpha = 1 - \\dfrac{1}{9} = \\dfrac{8}{9}$.<br>Thay vào $P$: $$P = 3\\left(\\dfrac{8}{9}\\right) + \\left(-\\dfrac{1}{3}\\right)^2 = \\dfrac{24}{9} + \\dfrac{1}{9} = \\dfrac{25}{9}$$"
    },
    {
      id: 2,
      skill: "Biến đổi biểu thức phân thức lượng giác theo tan alpha",
      question: "Câu 2. Cho $\\tan \\alpha = 2$. Tính giá trị của biểu thức $A = \\dfrac{3\\sin \\alpha - 2\\cos \\alpha}{2\\sin \\alpha + 5\\cos \\alpha}$.",
      answer_display: "4/9",
      acceptable: ["4/9", "4 / 9", "0.44", "0,44"],
      explanation: "Chia cả tử và mẫu cho $\\cos \\alpha \\neq 0$:<br>$$A = \\dfrac{3\\tan \\alpha - 2}{2\\tan \\alpha + 5} = \\dfrac{3(2) - 2}{2(2) + 5} = \\dfrac{4}{9}$$"
    },
    {
      id: 3,
      skill: "Tính giá trị biểu thức lượng giác kết hợp góc phụ nhau",
      question: "Câu 3. Tính giá trị của biểu thức $S = \\sin^2 15^\\circ + \\sin^2 35^\\circ + \\sin^2 55^\\circ + \\sin^2 75^\\circ - \\tan 40^\\circ \\cdot \\tan 50^\\circ$.",
      answer_display: "1",
      acceptable: ["1"],
      explanation: "Ta có: $\\sin^2 15^\\circ + \\sin^2 75^\\circ = 1$ và $\\sin^2 35^\\circ + \\sin^2 55^\\circ = 1$.<br>Lại có $\\tan 40^\\circ \\cdot \\tan 50^\\circ = \\tan 40^\\circ \\cdot \\cot 40^\\circ = 1$.<br>Vậy $$S = 1 + 1 - 1 = 1$$"
    },
    {
      id: 4,
      skill: "Tính tích sin.cos từ tổng sin + cos",
      question: "Câu 4. Cho góc $\\alpha$ tù thỏa mãn $\\sin \\alpha + \\cos \\alpha = \\dfrac{1}{5}$. Tính giá trị của tích $\\sin \\alpha \\cdot \\cos \\alpha$.",
      answer_display: "-12/25",
      acceptable: ["-12/25", "-12 / 25", "-0.48", "-0,48"],
      explanation: "Bình phương hai vế: $(\\sin \\alpha + \\cos \\alpha)^2 = \\dfrac{1}{25} \\iff 1 + 2\\sin \\alpha \\cos \\alpha = \\dfrac{1}{25}$<br>$$\\iff 2\\sin \\alpha \\cos \\alpha = -\\dfrac{24}{25} \\iff \\sin \\alpha \\cos \\alpha = -\\dfrac{12}{25}$$"
    },
    {
      id: 5,
      skill: "Ứng dụng giá trị lượng giác tính độ cao thực tế trong chuyển động tròn",
      question: "Câu 5 (Vận dụng thực tế). Một chiếc đu quay có bán kính $R = 30\\text{ m}$, tâm $O$ ở độ cao $35\\text{ m}$ so với mặt đất. Khi cabin di chuyển đến góc $\\alpha = 150^\\circ$ (so với tia $Ox$ nằm ngang hướng sang phải), tính độ cao của cabin đu quay so với mặt đất tại thời điểm đó (tính theo đơn vị mét).",
      answer_display: "50 m",
      acceptable: ["50", "50 m", "50m", "50 mét", "50met"],
      explanation: "Chọn hệ trục tọa độ $Oxy$ với gốc $O$ tại tâm đu quay (ở độ cao $35\\text{ m}$).<br>Tung độ của cabin so với tâm $O$ là: $$y = R \\sin 150^\\circ = 30 \\cdot \\dfrac{1}{2} = 15\\text{ m}$$<br>Độ cao của cabin so với mặt đất là: $$h = 35 + y = 35 + 15 = 50\\text{ m}$$"
    }
  ]
};
...
<body>
    ...
    <div class="quiz-content">
      ...
      <div class="exam-header-card">
        <div class="exam-info">
          ...
          <p>${quizData.subtitle} - Mức độ Thông hiểu & Vận dụng (Chế độ lời giải: BẬT).</p>
          <div class="exam-meta-tags">
            <span class="meta-tag">⏱️ 45 phút</span>
            <span class="meta-tag red">🎯 19 câu hỏi TH & VD</span>
      ...
      <div class="section-header-box" style="background: linear-gradient(135deg, #991b1b 0%, #dc2626 100%);">
        ...
        <p>Điền đáp số ngắn gọn vào ô tương ứng (bao gồm câu hỏi mô hình hóa thực tế). Mỗi câu đúng được 0.6 điểm.</p>
      </div>
  ...
  <script>
    ...
    function chamDiemBaiThi() {
      ...
      let gradeSub = "Em đã nắm rất chắc kiến thức về giá trị lượng giác từ 0° đến 180°!";
      if (diem_so < 5.0) {
        gradeTitle = "CẦN CỐ GẮNG HƠN!";
        gradeSub = "Em hãy ôn lại dấu lượng giác góc tù và các công thức góc bù/phụ phía dưới nhé.";
      } else if (diem_so < 8.0) {
        gradeTitle = "KẾT QUẢ KHÁ TỐT!";
        gradeSub = "Chú ý cẩn thận khi rút gọn biểu thức và xử lý bài toán thực tế đu quay.";
      }
      ...
      if (mang_cau_sai.length > 0) {
        ...
        skillsBox.innerHTML = '<b style="color: var(--success);">Tuyệt vời! Em không sai kỹ năng nào.</b>';
      }
...
const outputPath = path.join(__dirname, '..', 'To10_Web', 'To10_C3_B1_GTLG_0_180_TH_VD.html');
